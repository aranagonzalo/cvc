    ...
    return (
        <div className="flex flex-col w-max gap-2">
            {color === "blue" ? (
                <label
                    htmlFor="fileInput"
                    className={`text-custom-blue px-5 py-2 cursor-pointer font-medium hover:text-custom-cream hover:bg-custom-blue border-[2.5px] border-custom-blue rounded-full text-xl w-max`}
                >
                    Adjuntar archivo
                </label>
            ) : color === "grey" ? (
